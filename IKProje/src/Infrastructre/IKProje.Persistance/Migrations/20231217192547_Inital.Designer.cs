...
namespace IKProje.Persistance.Migrations
{
    ...
    [Migration("20231217192547_Inital")]
            ...
            modelBuilder.Entity("IKProje.Domain.Entities.Entity.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "7bccb460-a7da-4770-9744-c96d67977bd5",
                            Adres = "Kısıklı Mahallesi, Ferah Caddesi No: 1, 34692 Büyükçamlıca-Üsküdar, İstanbul, Türkiye",
                            CalisanSayisi = 51000,
                            CreatedTime = new DateTime(2023, 12, 17, 22, 25, 45, 855, DateTimeKind.Local).AddTicks(9901),
                            IsActive = true,
            ...
            modelBuilder.Entity("IKProje.Domain.Entities.Entity.Department", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "69173156-a937-4224-b9d0-d8e89a1b9f2f",
                            CreatedTime = new DateTime(2023, 12, 17, 22, 25, 45, 882, DateTimeKind.Local).AddTicks(7845),
                            IsActive = true,
                            Name = "Ik"
                        },
                        new
                        {
                            Id = "af750a1f-fba7-4db8-b503-cabc67df257c",
                            CreatedTime = new DateTime(2023, 12, 17, 22, 25, 46, 948, DateTimeKind.Local).AddTicks(5714),
                            IsActive = true,
                            Name = "Yazılım"
                        });
                });
            ...
            modelBuilder.Entity("IKProje.Domain.Entities.Entity.Vocation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "80ae71ee-bc4f-430c-ac7d-44b089c59c72",
                            CreatedTime = new DateTime(2023, 12, 17, 22, 25, 45, 894, DateTimeKind.Local).AddTicks(915),
                            IsActive = true,
                            Name = "Developer"
                        },
                        new
                        {
                            Id = "b22f7186-53b9-4616-a628-f0e9376490c9",
                            CreatedTime = new DateTime(2023, 12, 17, 22, 25, 46, 952, DateTimeKind.Local).AddTicks(536),
                            IsActive = true,
                            Name = "Satiş Müdürü"
                        });
                });
